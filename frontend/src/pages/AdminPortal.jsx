...
function AdminPortal() {
  ...
  const {fetchCategory, AddCategory, setupElection, RegisterCandidate, electionQueue, startVoting, endVoting, Compile, publish, upload, clear, pauseContract} = useContext(ConnectContext);
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-b from-gray-100 to-white">
          ...
          <div class="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
            ...
            <div class="text-right">
              <p class="text-2xl">{Queue.length}</p>
              <p>Election In Queue</p>
            </div>
          </div>
        </div>
        ...
        <div class="md:col-span-2 xl:col-span-3">
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
              ...
              ?   <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100 cursor-pointer" onClick={()=>start((election.category).toString())}> Approve Voting </span>
              : !election.VotingEnded ?
              <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700 cursor-pointer" onClick={()=>stop((election.category).toString())}> Stop Voting </span>
              : !election.VotingCounted ?
              
              <span class="px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full dark:text-gray-100 dark:bg-red-700 cursor-pointer" onClick={()=>Compile((election.category).toString())}> Compile Votes </span>
              
            :  election.isResultPublic ?
              
            <span class="px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full dark:text-gray-100 dark:bg-red-700 cursor-pointer" onClick={()=>publish((election.category).toString())}> Publicize Result </span>
            ...
            <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
              ...
              <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                <nav aria-label="Table navigation">
                  <ul class="inline-flex items-center">
                    ...
                    <li>
                      <button class="px-3 py-1 text-white dark:text-gray-800 transition-colors duration-150 bg-blue-600 dark:bg-gray-100 border border-r-0 border-blue-600 dark:border-gray-100 rounded-md focus:outline-none focus:shadow-outline-purple" onClick={clear}>Clear Queue</button>
                    </li>
              ...
              <div className='mt-5'>
        <button class="bg-red-500 hover:bg-blue-700 mr-6 text-white font-bold py-2 px-4 border border-blue-700 rounded cursor-pointer" onClick={()=>pauseContract(true)}>
  Pause
</button>
        <button class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded cursor-pointer" onClick={()=>pauseContract(false)}>
  UnPause
</button></div>
              </div>
